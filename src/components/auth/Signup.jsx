...
const Signup = () => {
  ...
  return (
    <form
      className="sm:border-gray-700 sm:border-2 sm:p-5 max-w-[500px] m-auto  flex flex-col gap-7 w-full sm:w-[500px] rounded"
    ...
    >
      ...
      <div className="input_field_container">
        ...
        <Input
          ...
          validation={{
            validate: (fieldValue) => {
              return fieldValue === password || "Password didn't match";
            },
          }}
