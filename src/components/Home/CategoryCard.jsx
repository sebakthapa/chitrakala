...
const CategoryCard = () => {
  const cardVariant = {
    ...
    hover: { scale: 1, y: -5, transition: { type: "spring", stiffness: 100, damping: 5 } },
    active: { scale: 1 },
  }
                    ...
                    <motion.div
                      ...
                      <h2 className="capitalize text-2xl font-sans   transition duration-1000  text-gray-700 font-extrabold">{type}</h2>
                        ...
                        <button className='group animate-pulse  text-gray-700  mt-3 rounded-full flex items-center gap-2 text-xs   transition duration-1000'>
                          ...
                          <span className=' '>
                            <BsArrowRight className='w-0  transition-all duration-500 ease-in-out group-hover:w-4 h-4' fill='gray' />
                          </span>
                        </button>
                      </div>
                    </motion.div>
