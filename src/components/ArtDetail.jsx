    ...
    useEffect(() => {
        ...
        const fetchDataAndLoading = async () => {
            try {
                ...
                await Promise.all([fetchData(), fetchArtistArtData(artdata?.artist?.user?._id)]);
            } finally {
            ...
            <div className="flex flex-wrap mt-10">
                ...
                <div className="w-full md:w-[70%] p-4">
                    ...
                    <section className=" flex flex-col justify-between  bg-white max-h-[150vh] md:h-[150vh]  ">
                            <h5 className="mb-2 p-5 text-2xl font-bold tracking-tight text-gray-900 ">{artdata?.name}</h5>
