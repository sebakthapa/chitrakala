...
const ExhibitionForm = () => {
  ...
  return (
    <>
        <h1 className="mainHead self-stretch font-serif bg-white sm:m-5 p-5   ">Upload Exhibition Details
      ...
      <section className=" formContainer self-stretch p-5 flex justify-center  sm:m-5 bg-white  ">
        <form action="#" className=" flex flex-col w-full sm:w-1/2 ">
          ...
          <label htmlFor="photo" className="block  text-sm font-bold text-gray-900 ">Photo<span className="text-red-500 ml-0">*</span></label>
          ...
          <label htmlFor="title" className="block  text-sm font-bold text-gray-900 ">Title<span className="text-red-500 ml-0">*</span></label>
          <input
            type="text"
            name='title'
            id='title'
          ...
          <label htmlFor="description" className="block  text-sm font-bold text-gray-900 ">About Exhibition<span className="text-red-500 ml-0">*</span></label>
          <textarea
            type="text"
            name='description'
            id='description'
          ...
          <label htmlFor="openDate" className="block  text-sm font-bold text-gray-900 ">Open Day of Exhibition<span className="text-red-500 ml-0">*</span></label>
          ...
          <input
            ...
            className=" border-gray-300 bg-transparent border-2 hover:border-gray-400 my-2 rounded-md p-2  "
          />
          <label htmlFor="closeDate" className="block  text-sm font-bold text-gray-900 ">Closing Day of Exhibition<span className="text-red-500 ml-0">*</span></label>
          ...
          <label htmlFor="location" className="block  text-sm font-bold text-gray-900 ">Location<span className="text-red-500 ml-0">*</span></label>
          <input
            type="text"
