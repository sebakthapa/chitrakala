...
const Page = () => {
  return (
    <>
        <h1 className="mainHead  font-serif p-5  m-5 bg-white ">Artist
        ...
        >
          Here you can find the artists who have contributed to our platform. <br /> Each artist has their own profile page where they present themselves, share their work,
        </p>
        </h1>
