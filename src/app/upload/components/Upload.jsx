        ...
        <>
            <form action="#" onSubmit={handleFileUpload} className="flex flex-col gap-8 justify-center w-full bg-white p-10 shadow-md ">
                ...
                <div className=" image input_field_container ">
                    ...
                    <input name='artPhoto' id="uploadimage" className=' m-0 w-0 h-0 border-gray-300 hover:border-gray-400 transition border-2 rounded-md' type="file" label={"Upload Image"} required onChange={handleFileChange} />
                    <div
                ...
                <div className="flex justify-between items-center gap-5">
                    ...
                    <div className=" input_field_container flex-1 flex flex-row justify-between">
                        <div className="flex flex-col gap-3">
                            ...
                            <label htmlFor="post-category" className='text-gray-500' >Category<span className="text-red-500">*</span></label>
                            <select
                                id='post-category'
                    ...
                    <div className="input_field_container flex-1">
                        <Input
                            ...
                            title={notForSale && "Price not needed for arts marked 'not for sale'."}
                            type="number"
                            value={price}
                            label={"Price"}
                            setValue={setPrice}
                ...
                <div className="input_field_container" >
                    ...
                    <div className='input_field_container'>
                        <div className="flex items-center gap-4">
                            <input className='h-4 w-4' checked={notForSale} type="checkbox" label={"Not for Sale"} onChange={() => setNotForSale((prev) => !prev)} />
